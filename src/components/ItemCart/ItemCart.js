        ...
        <div className='cart_detail'>
         ...
         <img className='cart_detailImg'  src={img} alt={name} />
            <div className='cart_detailDatos'> 
                ...
                <p>{ precioVenta < price ? 'Caja' : 'Bulto' }</p>  
                <p>Unidades: { precioVenta < price ? cantidadxCaja : boxcont } u</p>  
                <p>Cantidad: {quantity}</p> 
                <p>x</p>
                <p>Precio: USD${precioVenta}</p>
                <p>=</p>    
                <p>Subtotal: USD$ {quantity * precioVenta}</p>
              <p>Total:{ precioVenta < price ? quantity * cantidadxCaja : quantity * boxcont}</p>
